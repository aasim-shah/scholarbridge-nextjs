...
const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Search Scholarships', url: 'https://scholarbridge.com/search' }
])

const searchPageSchema = {
    '@context': 'https://schema.org',
    '@type': 'SearchResultsPage',
    name: 'Scholarship Search Results',
                ...
                <main className='container py-8'>
                    ...
                    <div className='mb-6'>
                        <div className='relative max-w-2xl'>
                            ...
                            <Input
                                type='search'
                                placeholder='Search scholarships by title, organization, country, or field of study...'
                                value={searchQuery}
                    ...
                    {filteredScholarships.length > 0 ? (
                        ...
                        <div className='text-center py-16 bg-card rounded-xl border border-border'>
                            ...
                            <p className='text-muted-foreground mb-4'>Try adjusting your search or filters to find more opportunities.</p>
                            {hasActiveFilters && (
                    ...
                    <div className='container'>
                        <div className='flex flex-col md:flex-row items-center justify-between gap-4'>
                            ...
                            <nav className='flex items-center gap-6 text-sm text-muted-foreground' aria-label='Footer navigation'>
                                ...
                                <Link href='/search' className='hover:text-foreground transition-colors' aria-current='page'>
                                    Browse
                                </Link>
